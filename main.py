...
async def start_command(event):
    ...
    msg = (
        ...
        f"2. /clone - Start File Transfer & Custom Rules\n"
...
# ================= 5. CLONE WIZARD (Interactive with Rules) =================
    ...
    async with bot.conversation(event.chat_id, timeout=300) as conv:
        ...
        try:
            ...
            while True:
                ...
                click_event = await conv.wait_event(events.CallbackQuery(pattern=b"^(rule_filename|rule_caption|start_transfer_task|cancel_clone)$"), timeout=120)
